...
if( !class_exists( 'UT_C7_Shortcode' ) ) {
    ...
    class UT_C7_Shortcode {
        ...
        function ut_map_shortcode() {
            ...
            if( is_array( $_skin_settings ) ) {

                foreach ($_skin_settings as $skin) {

                    $form_skins[$skin['title']] = $skin['unique_id'];
        ...
        function ut_create_shortcode( $atts ) {
            ...
            if( $form_skin == 'dark' || $form_skin == 'light' ) {
            ...
            if( $form_skin && $form_skin != 'dark' && $form_skin != 'light' ) {

                $_skin_settings = get_option('unite-cf7-designs');

                if( array_key_exists( $form_skin, $_skin_settings ) ) {

                    $id = $_skin_settings[$form_skin]['unique_id'];
                    $custom_css = ut_cf7_root_css( $_skin_settings[$form_skin], '#' . $_skin_settings[$form_skin]['unique_id'] ) . ut_cf7_skin_css( '#' . $_skin_settings[$form_skin]['unique_id'] );
