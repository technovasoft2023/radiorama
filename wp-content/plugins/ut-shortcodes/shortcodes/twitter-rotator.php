                            ...
                            $quote_rotator  .= '<div id="' . $id . '" class="ut-rotate-quote-alt flexslider">';    
                                $quote_rotator .= '<ul class="slides">';
                                    ...
                                    foreach($tweets as $tweet) :
                                        ...
                                        $quote_rotator .= '<li><i class="ut-rq-icon-tw fa-brands fa-x-twitter fa-3x"></i><div class="ut-quote-comment">' . $this->twitterify( $tweet->text ) . '</div><span class="ut-quote-name">' . $tweet->user->name . esc_html__(' about ' , 'ut_shortcodes') . $days . '</span></li>';
