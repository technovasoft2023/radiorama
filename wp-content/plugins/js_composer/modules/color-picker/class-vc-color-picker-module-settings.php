...
class Vc_Color_Picker_Module_Settings {
	...
	public function load_module_settings_assets() {
		wp_enqueue_style( 'pickr', vc_asset_url( 'lib/vendor/pickr/themes/classic.min.css' ), array(), WPB_VC_VERSION );
		wp_enqueue_script( 'pickr', vc_asset_url( 'lib/vendor/pickr/pickr.es5.min.js' ), array(), WPB_VC_VERSION, true );
