	...
	window.vc.EditElementPanelView = vc.PanelView
		...
		.extend( {
			...
			prepareContentBlock: function () {
				...
				this.$spinner = $( '<div class="ut_preloader small"><div class="loadingspinner"><div class="square1"></div><div class="square2"></div> <div class="square3"></div><div class="square4"></div><div class="square5"></div></div></div>' );
			...
			buildParamsContent: function ( data ) {
				...
				var cb = function () {
					...
					_self.$content.find('.ut_preloader').remove();
					_self.init();
					...
					//Unitedthems
					vc.events.trigger( 'vc:panel:ready', _self.$content );
				};
			...
			hide: function ( e ) {
				...
				$('a[data-element="toggle-sidebar"]').click();
