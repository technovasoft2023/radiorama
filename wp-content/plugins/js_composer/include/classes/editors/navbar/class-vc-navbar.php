...
class Vc_Navbar {
    ...
    public function getControlsSide() {
        $control_list = array();
        foreach ( $this->getControlListToolbar() as $control ) {
            $method = vc_camel_case( 'get_control_' . $control );
            if ( method_exists( $this, $method ) ) {
                $control_list[] = array(
                    $control,
        ...
        return apply_filters( $this->controls_filter_name.'_side', $control_list );
    }
    ...
    public function getControlListToolbar() {
        /**
         * Filters list of navbar controls.
         *
         * @param array $this->controls
         ...
         * @since 7.7
         */
        return apply_filters( 'vc_nav_control_list_side', $this->controls_side, $this );
    }
    ...
    public function ut_render() {
        vc_include_template( 'editors/navbar/ut-navbar.tpl.php', array(
            'css_class' => 'ut-vc-navbar',
            'controls' => $this->getControls(),
            'controls_side' => $this->getControlsSide(),
            'controls_bottom'   => $this->getBottomControls(),
            'nav_bar' => $this,
            'post' => $this->post(),
        ) );
    }

    public function ut_render_toolbar() {
        vc_include_template( 'editors/navbar/ut-navbar-toolbar.tpl.php', array(
            'css_class' => 'ut-vc-toolbar',
            'controls' => $this->getControls(),
            'controls_side' => $this->getControlsSide(),
            'nav_bar' => $this,
            'post' => $this->post(),
    ...
    public function getControlThemeSwitch() {
        return '<li class="vc_show-mobile vc_pull-right">' . '<a id="vc_theme-switch-button" class="vc_icon-btn vc_theme-switch-button" title="' . esc_attr__( 'Dark Mode', 'js_composer' ) . '"><i class="fa-solid fa-lightbulb vc_navbar-icon"></i></a>' . '</li>';
    }
