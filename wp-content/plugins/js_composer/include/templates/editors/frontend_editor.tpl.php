...
$title = __( 'Website Builder', 'js_composer' );
...
?>
	...
	<<?php echo esc_attr( $custom_tag ); ?>>
		document.getElementById( 'ut_preloader' ).style.height = window.screen.availHeight;
...
<?php vc_include_template( 'editors/partials/responsive-controls.php' ); ?>
