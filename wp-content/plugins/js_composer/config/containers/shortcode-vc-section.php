...
//		),
        ...
        array(
            ...
            'param_name' => 'el_name',
            'description' => __( 'Enter section name. This is for internal and external use and adds a label to the section for a better visual perception and its as part of the dot scroll navigation.', 'js_composer' ),
        ),
		array(
			'type' => 'checkbox',
