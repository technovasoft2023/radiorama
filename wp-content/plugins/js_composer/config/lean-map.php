...
//@united vc_lean_map( 'vc_tta_toggle', null, $vc_config_path . '/tta/shortcode-vc-tta-toggle.php' );
...
//@united vc_lean_map( 'vc_pricing_table', null, $vc_config_path . '/buttons/shortcode-vc-pricing-table.php' );
