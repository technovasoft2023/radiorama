...
if( ut_ut_check_plugin_running('woocommerce/woocommerce.php') ) {
    ...
    function ut_installation_note() { ?>
        ...
        <div class="grid-container section-content">
            ...
            <div class="section-content">
                ...
                <a href="https://united-themes.freshdesk.com/">https://united-themes.freshdesk.com</a>
                </p>
                
                <p><strong><?php _e( 'Useful links to start with:' , 'unitedthemes' ); ?></strong></p>
                
                <ul>
                    <li><a href="<?php echo esc_url( home_url() ); ?>/wp-admin/themes.php?page=install-required-plugins"><?php _e( 'Install required plugins', 'unitedthemes' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url() ); ?>/wp-admin/customize.php"><?php _e( 'Customize Theme', 'unitedthemes' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url() ); ?>/wp-admin/admin.php?page=ut_theme_options"><?php _e( 'Theme Options', 'unitedthemes' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url() ); ?>/wp-admin/nav-menus.php"><?php _e( 'Set Up Your Menu', 'unitedthemes' ); ?></a></li>
                </ul>
                </div>
