            ...
            'fields' => array(
                ...
                */
                ...
                array(
					...
					'desc' => 'Recommended size 1280x1280. We recommend using <a href="'.esc_url( __( 'https://goo.gl/Sj149K', 'unitedthemes' ) ).'" target="_blank">Kraken.io</a> services for image optimization.',
                    'type' => 'background',
					'global' => 'on',
                    'required' => array(
                        'ut_activate_page_hero' => 'on',
                ...
                array(
                    ...
                    'desc' => 'Recommended size 720x1280. We recommend using <a href="'.esc_url( __( 'https://goo.gl/Sj149K', 'unitedthemes' ) ).'" target="_blank">Kraken.io</a> services for image optimization.',
                    'type' => 'background',
					'global' => 'on',
                    'required' => array(
                        'ut_activate_page_hero' => 'on',
				...
				*/
	            ...
	            array(
		            ...
		            'metapanel' => 'ut-hero-content-caption-title-settings',
		            'desc' => sprintf( 'Select your desired font source. The theme currently supports %s and %s. The installed theme default font is %s.', '<a href="'.esc_url( __( 'http://www.w3schools.com/cssref/css_websafe_fonts.asp', 'unitedthemes' ) ).'" target="_blank">Web Safe Fonts</a>', '<a href="'.esc_url( __( 'https://fonts.google.com/', 'unitedthemes' ) ).'" target="_blank">Google Fonts</a>', '<a href="'.esc_url( __( 'https://www.fontsquirrel.com/fonts/raleway', 'unitedthemes' ) ).'" target="_blank">Raleway</a>' ),
		            'type' => 'select',
		            'std' => 'ut-font',
		            'required' => array(
                ...
                array(
                    ...
                    'metapanel' => 'ut-top-header-settings',
                    'label' => 'Select Menu',
                    'desc' => sprintf( 'In order to manage this menu please visit: Appearance > %s and create a new menu.   Menus in this area can only display 2 navigation level. Keep in mind, that you can also create similar navigations with the custom fields module. An advantage of the custom field module is, that you can use icons. But custom fields can only display with a single item level and has no dropdowns.', '<a target="_blank" href="' . get_admin_url() . 'nav-menus.php">Menus</a>'),
                    'type' => 'nav_menus',
                    'global' => 'on',
                    'required' => array(
                        'ut_page_top_header' => 'show|global',
                ...
                array(
                    ...
                    'metapanel' => 'ut-header-extra-modules-settings',
                    'label' => 'Select Menu',
                    'desc' => sprintf( 'In order to manage this menu please visit: Appearance > %s and create a new menu.  ', '<a target="_blank" href="' . get_admin_url() . 'nav-menus.php">Menus</a>'),
                    'type' => 'nav_menus',
                    'global' => 'on',
                    'required' => array(
                        'ut_header_layout' => 'default',
