...
if ( ! class_exists( 'OT_Settings' ) ) {
            ...
            foreach( $tweets as $tweet ) {
                ...
                echo '<li class="ut-single-tweet">';    
                    ...
                    echo '<div class="ut-tweet-icon">';
                        ...
                        echo '<i class="fa fa-brands fa-x-twitter" aria-hidden="true"></i>';
    ...
    public function display_loader( $section_ID ) {
        ...
        ob_start(); ?>
            ...
            <div id="<?php echo esc_attr( $section_ID ); ?>_loader" class="ut-panel-loader-wrap">
                        ...
                        <div id="ut-ui-admin-header" class="clearfix">
                            ...
                            <div class="grid-90 medium-grid-85 tablet-grid-66 mobile-grid-100 grid-parent">
                                ...
                                <div class="ut-admin-header-title">
                                    ...
                                    <!-- <button data-nonce="<?php echo wp_create_nonce( 'ut-restore-defaults-nonce' ); ?>" id="option-tree-settings-api-restore" class="ut-ui-button ut-ui-button-yellow load-default-settings"><?php esc_html_e( 'Load Theme Defaults','unitedthemes' ); ?></button> -->
                                    </h1>
                            ...
                            <ul id="ut-admin-outer-nav" class="ui-tabs-nav grid-100 medium-grid-100 tablet-grid-100 mobile-grid-100 grid-parent">
                                ...
                                <?php foreach( (array) $page['sections'] as $section ) : 
                                    ...
                                    <li class="<?php echo esc_attr( $active_class ); ?>" id="tab_<?php echo esc_attr( $section['id'] ); ?>">
                                
                                        <a href="#section_<?php echo esc_attr( $section['id'] ); ?>" data-section="<?php echo esc_attr( $section['id'] ); ?>" data-subsection="<?php echo esc_attr( $section['def_section'] ); ?>">
                            
                                            <?php if( !empty($section['icon']) ) : ?>
                                                
                                                <?php $folder = ot_get_option( 'ut_theme_options_skin', 'unite-admin-dark' ) == 'unite-admin-light' ? 'dark/' : ''; ?>
                                            
                                                <span class="ut-icon-bg"><img class="ut-panel-png-icon" src="<?php echo FW_WEB_ROOT; ?>/core/admin/assets/img/panel_icons/<?php echo esc_attr( $folder ).esc_attr( $section['icon'] ); ?>"></span>
                                            
                                            <?php endif; ?>
                                            
                                            <span class="icon-desc"><?php echo esc_html( $section['title'] ); ?></span>
                            ...
                            <div class="grid-20 grid-parent hide-on-desktop hide-on-medium hide-on-tablet hide-on-mobile">
    ...
    public function sanitize_callback( $input ) {
		...
		/* loaded panels */
        $loaded_panels = isset( $_POST['ut_loaded_panels'] ) ? filter_input( INPUT_POST, 'ut_loaded_panels', FILTER_SANITIZE_SPECIAL_CHARS ) : '';
        if( ! empty( $loaded_panels ) ) {
            $loaded_panels = explode( ',' , $loaded_panels );
        }
        $panels_to_load = $this->panels_to_load( $loaded_panels );
        $loaded_sub_panels = isset( $_POST['ut_loaded_sub_panels'] ) ? filter_input( INPUT_POST, 'ut_loaded_sub_panels', FILTER_SANITIZE_SPECIAL_CHARS ) : '';
        if( ! empty( $loaded_sub_panels ) ) {
            $loaded_sub_panels = explode( ',' , $loaded_sub_panels );
        }
            ...
            echo '<div id="section_' . $section['id'] . '" data-section-id="' . $section['id'] . '" class="ut-options-outer-panel-group ' . $active_section . ' ' . ( $sub_loading ? 'ut-has-sub-dependencies' : '' ) . '">';
                ...
                echo '<div class="ut-options-outer-panel-group-append">';
                    ...
                    echo '<div id="' . $section['id'] . '_placeholder" class="ut-options-inner-panel-placeholder ut-hide">'; 
                        ...
                        echo '<div class="ut-panel-options-wrap grid-85 medium-grid-70 tablet-grid-66 mobile-grid-100 grid-parent">';
    ...
    public function ajax_do_settings_subsections() {
        ...
        $section_id = isset( $_POST['section'] ) ? filter_input( INPUT_POST, 'section', FILTER_SANITIZE_SPECIAL_CHARS ) : '';
    ...
    public function ajax_do_settings_subpanels() {
        ...
        $panel_id   = isset( $_POST['panel_id'] ) ? filter_input( INPUT_POST, 'panel_id', FILTER_SANITIZE_SPECIAL_CHARS ) : '';
        $section_id = isset( $_POST['section_id'] ) ? filter_input( INPUT_POST, 'section_id', FILTER_SANITIZE_SPECIAL_CHARS ) : '';
