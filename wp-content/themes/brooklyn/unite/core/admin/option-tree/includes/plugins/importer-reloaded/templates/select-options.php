...
<div class="grid-100">
	...
	<div class="ut-dashboard-widget ut-dashboard-widget-demo-summary">	
		...
		<div class="ut-dashboard-widget-demo-summary-header">
			...
			<h3><?php echo esc_html( $ut_demo_importer_info[$this->xml_id]['name'] ); ?></h3>
		...
		<div class="ut-dashboard-widget-demo-summary-content">
			...
			<div class="ut-demo-importer-summary-box">
				...
				<span class="ut-demo-importer-summary-count"><?php echo esc_html( $data->post_count ); ?></span>
			...
			<div  class="ut-demo-importer-summary-box">
				...
				<span class="ut-demo-importer-summary-count"><?php echo esc_html( $data->media_count ); ?></span>
			...
			<div class="ut-demo-importer-summary-box">
				...
				<span class="ut-demo-importer-summary-count"><?php echo esc_html( $data->comment_count ); ?></span>
			...
			<div class="ut-demo-importer-summary-box">
				...
				<span class="ut-demo-importer-summary-count"><?php echo esc_html( $data->term_count ); ?></span>
	...
	<div class="ut-dashboard-widget ut-dashboard-widget-demo-summary">
		...
		<img src="<?php echo THEME_WEB_ROOT; ?>/admin/assets/images/importer/<?php echo esc_attr( $ut_demo_importer_info[$this->xml_id]['preview'] ); ?>.jpg" />
