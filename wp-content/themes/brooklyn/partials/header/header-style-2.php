     ...
     <div class="grid-container">
        ...
        <div class="ha-header-perspective clearfix">
            ...
            <div class="ha-header-front clearfix">
				...
				<div class="ut-header-primary-extra-module ut-header-extra-module <?php echo esc_attr($header->extra_modul_class('primary')); ?> ut-header-extra-module-right ut-header-extra-module-small <?php echo esc_attr($header->extra_modul_flush_class()); ?> grid-15 hide-on-tablet hide-on-mobile">
