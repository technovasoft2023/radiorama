		...
		<div class="grid-container">
			...
			<div class="ha-header-perspective clearfix">
				...
				<div class="ha-header-front ha-header-front-upper clearfix">
					...
					<div class="ut-header-primary-extra-module ut-header-extra-module <?php echo esc_attr( $header->extra_modul_class('primary') ); ?> ut-header-extra-module-small <?php echo esc_attr( $header->extra_modul_flush_class() ); ?> grid-45 hide-on-tablet hide-on-mobile">

						<?php $header->create_primary_header_extra(); ?>

					</div>
					
					<div class="ut-header-secondary-extra-module ut-header-extra-module <?php echo esc_attr( $header->extra_modul_class('secondary') ); ?> ut-header-extra-module-right ut-header-extra-module-small grid-40 hide-on-tablet hide-on-mobile">
		...
		<div class="grid-container">
			...
			<div class="ha-header-perspective clearfix">
				...
				<div class="ha-header-front ha-header-front-lower clearfix">
                    ...
                    <div class="ut-header-tertiary-extra-module ut-header-extra-module <?php echo esc_attr( $header->extra_modul_class('tertiary') ); ?> ut-header-extra-module-small <?php echo esc_attr( $header->extra_modul_flush_class() ); ?> grid-20 hide-on-tablet hide-on-mobile">
