...
<section id="ut-hero" class="hero ha-waypoint parallax-section parallax-background <?php echo implode( " " , $hero_classes ); ?>" data-animate-up="ha-header-hide" data-animate-down="ha-header-hide">
        ...
        <div class="parallax-scroll-container hero-parallax-scroll-container parallax-scroll-container-hide <?php echo ut_return_hero_config('ut_hero_image_parallax') == 'off' ? 'parallax-scroll-container-disabled' : ''; ?>" data-parallax-bottom data-parallax-factor="8">
            ...
            <div class="parallax-image-container">
                ...
                <?php if( ut_collect_option( 'ut_hero_glitch' , 'off' ) == 'on' && class_exists('UT_Glitch_Effect') ) {
                    ...
                    echo ut_safe_output( $glitch->render() );
    ...
    <?php endif; ?>
        ...
        if( $ut_hero_rain_effect ) : ?>
            ...
            <img id="ut-rain-background" src="<?php echo esc_url($ut_hero_rain_effect); ?>" alt="rain"/>
        ...
        <div class="grid-container">
            ...
            <!-- start hero-holder -->
            <div class="hero-holder ut-split-hero grid-100 mobile-grid-100 tablet-grid-100 <?php echo ut_compare_values($ut_hero_split_content_type, 'form') ? 'ut-hero-highlighted-with-form' : '' ; ?> <?php echo ut_return_hero_config('ut_hero_style' , 'ut-hero-style-1'); ?> hero-holder-align-items-<?php echo ut_return_hero_config('ut_hero_v_align', 'middle'); ?>">
                ...
                <div class="hero-inner" style="text-align:<?php echo ut_return_hero_config('ut_hero_align' , 'center'); ?>;">
                    ...
                    <div class="ut-hero-highlighted-header">
                        ...
                        <?php if( $ut_hero_animation_element_group ) : ?> <div class="<?php echo esc_attr($ut_hero_animation_element_group); ?>"> <?php endif; ?>
                        ...
                        <?php if( $ut_hero_animation_element_group_split ) : ?> <div class="ut-hero-animation-element ut-hero-animation-element-upper"> <?php endif; ?>
                            ...
                            <?php if( !empty( $ut_custom_slogan ) ) : ?>
                                ...
                                <div class="<?php echo esc_attr($ut_hero_animation_element_single); ?>">
                            ...
                            <?php if( !empty( $ut_custom_logo  ) ) : ?>
                                ...
                                <div class="ut-hero-custom-logo-holder">
                                    <img class="<?php echo esc_attr($ut_hero_animation_element_single); ?>" src="<?php echo esc_url( $ut_custom_logo  ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" />
                                </div>
                            ...
                            <?php if( !empty($ut_expertise_slogan) ) : ?>
                                ...
                                <div class="hdh">
                                    <span data-responsive-font="hero_slogan" class="hero-description <?php echo esc_attr($ut_hero_animation_element_single); ?>">
                            ...
                            <?php endif; ?>
                                ...
                                <?php if( !empty( $ut_company_slogan ) ) : ?>
                                    ...
                                    <div class="hth">
                                        <h1 data-title="<?php echo esc_attr( $ut_data_company_slogan ); ?>" data-responsive-font="hero_title" class="hero-title <?php echo esc_attr($ut_hero_animation_element_single); ?> element-with-custom-line-height <?php echo implode( " ", $hero_title_classes ); ?>">
                        ...
                        <?php if( $ut_hero_animation_element_group_split ) : ?> <div class="ut-hero-animation-element ut-hero-animation-element-lower"> <?php endif; ?>
                            ...
                            <?php if( !empty( $ut_catchphrase ) ) : ?>
                                ...
                                <div class="hdb">
                                    <span data-responsive-font="hero_description" class="hero-description-bottom <?php echo esc_attr($ut_hero_animation_element_single); ?>">
                    ...
                    <div class="ut-hero-highlighted-item">
                        ...
                        <?php if( $ut_hero_split_content_type == 'image' && !empty( $ut_hero_split_image ) ) : 
                            ...
                            if( !empty( $ut_hero_split_image_effect ) && $ut_hero_split_image_effect !='none' ) {
                                ...
                                $dataeffect = 'data-effect="' . esc_attr($ut_hero_split_image_effect) . '"';
                                $animated   = 'ut-animate-element animated';                                    

                            } ?>

                            <div class="ut-split-image">
                                <img class="<?php echo esc_attr($animated); ?>" <?php echo filter_var($dataeffect); ?> alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" src="<?php echo esc_url( $ut_hero_split_image ); ?>" />
                            </div>
                        ...
                        <?php if( $ut_hero_split_content_type == 'video' && !empty( $ut_hero_split_video ) ) : 
                            ...
                            <div class="ut-hero-video <?php echo ut_compare_values( $ut_hero_split_video_box, 'on' ) ? 'ut-hero-video-boxed' : ''; ?> <?php echo esc_attr($style); ?>">
                                <div class="ut-video">
