...
<?php if ( have_posts() ) : ?>
        ...
        <?php while ( have_posts() ) : the_post(); ?>
            ...
            <?php if( $shortcodes_custom_css ) : ?>
                ...
                <style type="text/css">
                    <?php echo ut_safe_output($shortcodes_custom_css); ?>
                </style>
            ...
            */
            ...
            <?php if( $ut_parallax_section == 'on') : ?>
                ...
                <section id="<?php echo esc_attr($post_name); ?>" data-effect="fadeIn" data-width="<?php echo esc_attr($data_width); ?>" class="page-id-<?php echo esc_attr($post->ID); ?> entry-content parallax-banner parallax-section <?php echo esc_attr($ut_section_width_class); ?> <?php echo esc_attr($ut_section_skin); ?> <?php echo esc_attr($ut_section_class); ?> <?php echo esc_attr($shadow); ?>">
                    ...
                    <?php if( $ut_overlay_section == 'on') : ?>
                        ...
                        <div class="parallax-overlay <?php echo esc_attr($ut_overlay_pattern); ?> <?php echo esc_attr($ut_overlay_pattern_style); ?>">
                        
                    <?php endif; ?>                        
                    
                    <a class="ut-offset-anchor" <?php echo filter_var($post_parent); ?> id="section-<?php echo esc_attr($post_name); ?>" name="section-<?php echo esc_attr($post_name); ?>"><?php echo esc_html($post_name); ?></a>
                        ...
                        <?php if( $ut_split_content_align == 'left' ) : ?>                            
                            ...
                            <div class="grid-40 prefix-5 suffix-5 tablet-grid-40 tablet-prefix-5 tablet-suffix-5 mobile-grid-100 ut-split-content-left">
                                    ...
                                    <?php if( $ut_display_section_header == 'show' ) : ?>
                                           ...
                                           <header class="<?php echo empty($ut_parallax_image)  ? 'section-header' : 'parallax-header'; ?> <?php echo esc_attr($ut_section_header_style); ?> <?php echo esc_attr($ut_section_header_text_align); ?>">
                                                
                                                <?php if( $ut_section_header_style == 'pt-style-1' ) : ?>
                                                
                                                    <h2 class="bklyn-divider-styles bklyn-divider-style-1 <?php echo empty($ut_parallax_image) ? 'section-title' : 'parallax-title'; ?> <?php echo esc_attr($ut_section_title_glow); ?>"><span><?php the_title(); ?></span></h2>
                            ...
                            <div class="grid-50 <?php echo (!empty($poster_image)) ? 'tablet-grid-50 mobile-grid-100' : 'hide-on-tablet hide-on-mobile'; ?> tablet-grid-50 mobile-grid-100 ut-split-screen-poster" data-posterparent="<?php echo esc_attr($post_name); ?>"></div>
                                    ...
                                    <?php if( $ut_display_section_header == 'show' ) : ?>
                                           ...
                                           <header class="<?php echo empty($ut_parallax_image)  ? 'section-header' : 'parallax-header'; ?> <?php echo esc_attr($ut_section_header_style); ?> <?php echo esc_attr($ut_section_header_text_align); ?>">
                                                ...
                                                <?php else : ?>
                                                    ...
                                                    <h2 class="<?php echo empty($ut_parallax_image) ? 'section-title' : 'parallax-title'; ?> <?php echo esc_attr($ut_section_title_glow); ?>"><span><?php the_title(); ?></span></h2>
                    ...
                    <?php else : ?>
                        ...
                        <div class="<?php if($ut_section_width == 'centered') : ?>grid-container<?php endif; ?> parallax-content section-header-holder">
                            ...
                            <?php if( $ut_display_section_header == 'show' ) : ?>                                    
                                ...
                                <header class="parallax-header <?php echo esc_attr($ut_section_header_style); ?> <?php echo esc_attr($ut_section_header_text_align); ?>">
                                    
                                    <?php if( $ut_section_header_style == 'pt-style-1' ) : ?>
                                    
                                        <h2 class="bklyn-divider-styles bklyn-divider-style-1 parallax-title <?php echo esc_attr($ut_section_title_glow); ?>"><span><?php the_title(); ?></span></h2>
                                    
                                    <?php else : ?>
                                        
                                        <h2 class="parallax-title <?php echo esc_attr($ut_section_title_glow); ?>"><span><?php the_title(); ?></span></h2>
                        ...
                        <div class="<?php if($ut_section_width == 'centered') : ?>grid-container<?php endif; ?> parallax-content section-header-holder">
                            ...
                            <!-- parallax header -->
                            <div class="grid-50 mobile-grid-100 tablet-grid-50 ut-split-screen <?php echo esc_attr($push_pull); ?>">
                        ...
                        <?php if( !empty($ut_section_header_align) && $ut_section_header_align == 'center' ) : ?> 
                            ...
                            <?php if( $ut_display_section_header == 'show' ) : ?>
                                ...
                                <div class="<?php if($ut_section_width == 'centered') : ?>grid-container<?php endif; ?> parallax-content section-header-holder">  
                                    ...
                                    <!-- parallax header -->
                                    <div class="<?php echo esc_attr($ut_section_header_width); ?> mobile-grid-100 tablet-grid-100">
                                        <header class="parallax-header <?php echo esc_attr($ut_section_header_style); ?> <?php echo esc_attr($ut_section_header_text_align); ?>">
                ...
                <div class="ut-scroll-up-waypoint" data-section="section-<?php echo esc_attr($post_name); ?>" <?php echo filter_var($post_parent); ?>></div>
            ...
            */
            ...
            <section id="<?php echo esc_attr($post_name); ?>" data-effect="fadeIn" data-width="<?php echo esc_attr($ut_section_width); ?>" class="page-id-<?php echo esc_attr($post->ID); ?> entry-content normal-background <?php echo esc_attr($ut_section_width_class); ?> <?php echo esc_attr($ut_section_skin); ?> <?php echo esc_attr($ut_section_class); ?> <?php echo esc_attr($shadow); ?> <?php echo esc_attr($ut_section_video_class); ?>">
                    ...
                    */
                    ...
                    <?php if( $ut_section_width == 'split' ) : ?>
                        ...
                        <?php if( $ut_split_content_align == 'left' ) : ?>                            
                            ...
                            <div class="grid-50 <?php echo (!empty($poster_image)) ? 'tablet-grid-50 mobile-grid-100' : 'hide-on-tablet hide-on-mobile'; ?> ut-split-screen-poster" data-posterparent="<?php echo esc_attr($post_name); ?>"></div>
                    ...
                    <?php else : ?>
                        ...
                        <div class="<?php if($ut_section_width == 'centered') : ?>grid-container<?php endif; ?> section-header-holder">
                            ...
                            <!-- section header -->
                            <div class="grid-50 tablet-grid-50 mobile-grid-100 ut-split-screen <?php echo esc_attr($push_pull); ?>">
