            ...
            <div class="hero-inner">             
                ...
                <?php if ( !have_posts() ) : ?>
                    ...
                    <form role="search" method="get" class="search-form" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        ...
                        <label>
                            <input type="search" class="search-field" placeholder="<?php esc_attr_e( 'To search type and hit enter' , 'unitedthemes' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" title="<?php esc_attr_e( 'Search for:' , 'unitedthemes' ); ?>">
                        </label>
                        
                        <a id="ut-hero-search-submit" class="hero-btn" href="#"><?php esc_html_e( 'Search' , 'unitedthemes' ); ?></a>
