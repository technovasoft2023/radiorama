...
<?php if( is_home() ) : ?>
    ...
    <div class="grid-container">
        ...
        <div id="primary" class="grid-parent <?php echo esc_attr($grid); ?>">
...
<?php elseif( is_front_page() && ot_get_option( 'ut_site_layout', 'multisite' ) == 'multisite' ) : ?>
    ...
    <?php endif; ?>
        ...
        <div id="primary" class="grid-parent grid-100 tablet-grid-100 mobile-grid-100 <?php echo esc_attr($ut_page_class); ?>">
