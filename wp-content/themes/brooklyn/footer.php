		...
		<?php if( !apply_filters( 'ut_contact_section_is_cblock', false ) ) : ?>
			...
			<section id="contact-section" data-effect="fadeIn" class="animated contact-section <?php echo implode(" ", $csection_classes); ?>">   		
				...
				<?php if( $ut_csection_overlay == 'on' ) : ?>
					...
					<div class="parallax-overlay <?php echo esc_attr($ut_csection_overlay_pattern); ?> <?php echo esc_attr(ot_get_option( 'ut_csection_overlay_pattern_style' , 'style_one' )); ?>">
				...
				<div class="grid-container parallax-content">
					...
					<div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
						...
						<header class="csection-title <?php echo esc_attr($ut_csection_title_style); ?>-header <?php echo esc_attr($ut_csection_header_style); ?> ut-no-lead-linebreak-mobile <?php echo esc_attr($ut_csection_title_align); ?>">

                            <?php if( !empty( $glitch_classes ) ) : ?>

                                <div class="<?php echo esc_attr(implode( " ", $glitch_classes )); ?>" <?php echo filter_var( $glitch_attributes ); ?>>
							...
							<?php if( !empty( $ut_csection_header_slogan ) ) : ?>
								...
								<?php if( $ut_csection_header_style == 'pt-style-1' ) : ?>
									...
									<h2 data-title="<?php echo esc_attr( $ut_data_csection_header_slogan ); ?>" data-responsive-font="contact_section_title" class="bklyn-divider-styles bklyn-divider-style-1 <?php echo esc_attr($ut_csection_title_style); ?>-title <?php echo esc_attr(implode(" ", $csection_title_classes ));?>">
				...
				<div class="grid-container section-content">
					...
					<div class="grid-100 mobile-grid-100 tablet-grid-100 grid-parent">
						<div class="contact-wrap clearfix">
							...
							<!-- contact message -->
							<div class="<?php echo esc_attr($ut_left_csection_content_area_width); ?>">
							...
							<!-- contact form-holder -->
							<div class="<?php echo esc_attr($ut_right_csection_content_area_width); ?>">
    ...
    <?php // Footer Section opening tag in sidebar-footer.php ?>
        ...
        <?php if( ut_page_option( 'ut_subfooterarea', 'on' ) == 'on' ) :
            ...
            <div class="footer-content" data-cursor-skin="<?php echo esc_attr( $sub_footer_cursor_skin ); ?>">
                            ...
                            if( is_array( $social ) && !empty( $social ) ) {
                                ...
                                echo '<div class="ut-sub-footer-social-icons"><ul class="ut-footer-so">';    
                                    ...
                                    foreach( $social as $icon => $value) {
                                        ...
                                        echo '<li>';
                                            echo '<a target="_blank" ' . $title . ' area-label="'.esc_attr($label).'" href="' . esc_url( $link ) . '"><i class="fa ' . esc_attr( $value["icon"] ) . ' fa-lg"></i></a>';
                                        echo '</li>';
