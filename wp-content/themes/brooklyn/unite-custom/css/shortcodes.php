    ...
    class UT_Shortcodes_CSS extends UT_Custom_CSS {
        ...
        public function custom_css() {
            ...
            <style id="ut-shortcode-custom-css" type="text/css">
                ...
                .bklyn-btn-effect-aylen::before {
                    background:rgb(<?php echo esc_attr( $this->hex_to_rgb( $this->accent ) ); ?>); 
                    background:rgba(<?php echo esc_attr( $this->hex_to_rgb( $this->accent ) ); ?>, 0.6); 
                }
                ...
                #ut-scroll-dots.ut-scroll-dots-light > div.selected {
                    border: 2px solid <?php echo esc_attr( $this->accent ); ?>;
                ...
                .ut-rotate-quote-alt .flex-direction-nav a { 
                    background:rgb(<?php echo esc_attr( $this->hex_to_rgb( $this->accent ) ); ?>); 
                    background:rgba(<?php echo esc_attr( $this->hex_to_rgb( $this->accent ) ); ?>, 0.85); 
                }
                ...
                .ut-social-link:hover .ut-social-icon { 
                    background:<?php echo esc_attr( $this->accent ); ?> !important; 
                }
                ...
                .light .ut-nav-tabs li a:hover { 
                    border-color:<?php echo esc_attr( $this->accent ); ?> !important; 
                }
                ...
                <?php if( $this->is_hex( $this->accent ) ) : ?>
                    ...
                    .ut-image-gallery-loader .ut-image-gallery-loader-inner {
                        border: 2px solid rgba(<?php echo esc_attr( $this->hex_to_rgb( $this->accent ) ); ?>, 0.65);
                        border-right-color: rgba(<?php echo esc_attr( $this->hex_to_rgb( $this->accent ) ); ?>, 0.15);
                        border-bottom-color: rgba(<?php echo esc_attr( $this->hex_to_rgb( $this->accent ) ); ?>, 0.15);
                    }

                <?php else : ?>

                    .ut-image-gallery-loader .ut-image-gallery-loader-inner {
                        border: 2px solid <?php echo esc_attr( $this->rgb_to_rgba( $this->accent , '0.65' ) ); ?>;
                        border-right-color: <?php echo esc_attr( $this->rgb_to_rgba( $this->accent , '0.15' ) ); ?>;
                        border-bottom-color: <?php echo esc_attr( $this->rgb_to_rgba( $this->accent , '0.15' ) ); ?>;
                    }
                ...
                <?php if( ot_get_option( 'ut_global_header_glitch', 'off' ) == 'on' ) : ?>
                    ...
                    if( $ut_global_header_glitch_accent_1 ) : ?>
                        ...
                        .parallax-title.ut-glitch-1::after {
                            color: <?php echo esc_attr( $ut_global_header_glitch_accent_1 ); ?>;
                        }

                        .section-title.ut-glitch-2::after,
                        .parallax-title.ut-glitch-2::after {
                            text-shadow: 1px 0 <?php echo esc_attr( $ut_global_header_glitch_accent_1 ); ?>;
                        }
                    ...
                    if( $ut_global_header_glitch_accent_2 ) : ?>
                        ...
                        .parallax-title.ut-glitch-1::before {
                            color: <?php echo esc_attr( $ut_global_header_glitch_accent_2 ); ?>;
                        }

                        .section-title.ut-glitch-2::before,
                        .parallax-title.ut-glitch-2::before {
                            text-shadow: -1px 0 <?php echo esc_attr( $ut_global_header_glitch_accent_2 ); ?>;
                        }
                ...
                <?php if( ot_get_option( 'ut_global_header_glow', 'off' ) == 'on' ) :
                    ...
                    if( $ut_global_header_glow_color ) : ?>
                        ...
                        .section-title.ut-glow span {
                            -webkit-text-shadow: 0 0 40px <?php echo esc_attr(  $ut_global_header_glow_color ); ?>,  2px 2px 3px <?php echo ot_get_option('ut_global_header_glow_shadow_color', 'black' ); ?>;
                            -moz-text-shadow: 0 0 40px <?php echo esc_attr( $ut_global_header_glow_color ); ?>,  2px 2px 3px <?php echo ot_get_option('ut_global_header_glow_shadow_color', 'black' ); ?>;
                            text-shadow: 0 0 40px <?php echo esc_attr( $ut_global_header_glow_color ); ?>,  2px 2px 3px <?php echo ot_get_option('ut_global_header_glow_shadow_color', 'black' ); ?>;
                        }
