                        ...
                        while ( $css_query->have_posts() ) : $css_query->the_post();
                            ...
                            $ut_section_video_state = get_post_meta( $css_query->post->ID , 'ut_section_video_state' , true );
                                ...
                                $ut_section_header_font_style = empty($ut_section_header_font_style) ? 'semibold' : $ut_section_header_font_style;
                                    ...
                                    /* add to CSS */
                                    echo ut_safe_output( $this->global_headline_font_style('#' . ut_clean_section_id($css_query->post->post_name) . ' .parallax-title' , $ut_section_header_font_style) );
                                    echo ut_safe_output( $this->global_headline_font_style('#' . ut_clean_section_id($css_query->post->post_name) . ' .section-title' , $ut_section_header_font_style) );
                                ...
                                if( is_array( $ut_parallax_image ) && !empty( $ut_parallax_image['background-image'] ) ) {
                                    ...
                                    if( !empty( $ut_parallax_image ) && $ut_parallax_section == 'on' ) {
                                        ...
                                        echo ut_safe_output( $this->css_background( '#' . ut_clean_section_id( $css_query->post->post_name ) . ' .parallax-scroll-container' , $ut_parallax_image ) );
                                        
                                    } else {
                                        
                                        echo ut_safe_output( $this->css_background( '#' . ut_clean_section_id($css_query->post->post_name) , $ut_parallax_image ) );
                            ...
                            if( !empty( $ut_section_title_color ) ) {
                                ...
                                echo ut_safe_output( $this->section_headline_css( '#' . ut_clean_section_id($css_query->post->post_name) , $ut_section_header_style , $ut_section_title_color ) );
                            ...
                            echo ut_safe_output( $this->section_headline_css( '#' . ut_clean_section_id( $css_query->post->post_name ), 'pt-style-2', $ut_section_headline_style_2_color, $ut_section_headline_style_2_height, $ut_section_headline_style_2_width ) );
                            ...
                            if( $ut_global_headline_style_2_spacing_top ) { ?>
                                ...
                                <?php echo '#' . ut_clean_section_id( $css_query->post->post_name ); ?> .pt-style-2 .section-title:after {
                                    margin: <?php echo esc_attr( $this->add_px_value( $ut_global_headline_style_2_spacing_top ) ); ?> auto 0;
                                }
                                ...
                                <?php echo '#' . ut_clean_section_id( $css_query->post->post_name ); ?> .pt-style-2.header-left .section-title:after {
                                    margin: <?php echo esc_attr( $this->add_px_value( $ut_global_headline_style_2_spacing_top ) ); ?> 0 0;
                                }
                                ...
                                <?php echo '#' . ut_clean_section_id( $css_query->post->post_name ); ?> .pt-style-2.header-right .section-title:after {
                                    margin: <?php echo esc_attr( $this->add_px_value( $ut_global_headline_style_2_spacing_top ) ); ?> 0 0 auto;
                                }
