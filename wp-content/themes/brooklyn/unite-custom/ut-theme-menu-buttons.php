            ...
            <li id="menu-item-<?php echo esc_attr($item_id); ?>" class="<?php echo implode(' ', $classes ); ?>">
                    ...
                    <div class="menu-item-handle">
                        ...
                        <span class="menu-item-title"><?php echo esc_html( $title ); ?></span> 
                            ...
                            <?php if( 'megamenu-button' == $item->object ) : ?>
                                ...
                                <span id="mega-menu-button-<?php echo esc_attr($item_id); ?>" class="ut-is-button"><?php esc_html_e( 'Button', 'unite' ); ?></span>

                            <?php else: ?>

                                <span class="is-submenu" <?php echo esc_attr($submenu_text); ?>><?php _e( 'sub item' , 'unite' ); ?></span>
                ...
                <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
                    ...
                    <div class="clear"></div>
                        ...
                        <?php if( 'megamenu-button' == $item->object ) : ?>
                            ...
                            <div class="ut-megamenu-settings">
                                ...
                                <div id="ut-megamenu-settings-<?php echo esc_attr($item_id); ?>" class="ut-megamenu-settings-inner has-tabs">
                    ...
                    <div class="menu-item-actions description-wide submitbox">
                        ...
                        ); ?>"><?php _e( 'Remove', 'unite' ); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array( 'edit-menu-item' => $item_id, 'cancel' => time() ), admin_url( 'nav-menus.php' ) ) );
                            ?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php _e('Cancel', 'unite'); ?></a>
                    </div>
