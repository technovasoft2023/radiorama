    ...
    function unitedthemes_content_nav( $nav_id ) {
        ...
        <?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
            ...
            <div class="nav-previous">
                <a href="<?php next_posts().esc_attr($anchor); ?>"><i class="Bklyn-Core-Left-2"></i> <?php esc_html_e( 'Previous', 'unitedthemes' ); ?></a>
            </div>
            ...
            <div class="nav-next">
                <a href="<?php previous_posts().esc_attr($anchor); ?>"><?php esc_html_e( 'Next','unitedthemes' ); ?> <i class="Bklyn-Core-Right-2"></i></a>
            </div>
